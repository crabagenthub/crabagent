...
export const COLLECTOR_API = {
  ...
  riskOverviewDailyRiskTrends: "/v1/risk-overview/daily-risk-trends",
  riskOverviewTrend: "/v1/risk-overview/trend",
  investigationTimeline: "/v1/investigation/timeline",
...
export const COLLECTOR_QUERY_SCOPE = {
  ...
  riskOverviewDailyRiskTrends: "risk-overview-daily-risk-trends",
  riskOverviewTrend: "risk-overview-trend",
