...
export function TraceSpanAttributesPanel({ span }: { span: SemanticSpanRow | null }) {
  ...
  if (!span) {
    return (
      <div className="flex h-full min-h-[160px] flex-col justify-center border-t border-ca-border bg-neutral-50/50 p-4 text-center xl:border-l xl:border-t-0">
  ...
  return (
    <aside className="flex h-full min-h-0 w-full min-w-0 flex-col border-t border-ca-border bg-neutral-50/40 lg:border-l lg:border-t-0">
      <div className="shrink-0 border-b border-ca-border bg-white/90 px-3 py-2">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 py-1">
        ...
        <AttrRow
          ...
          value={totalTok > 0 ? totalTok.toLocaleString() : "—"}
        />
        {totalTok > 0 ? (
          <p className="-mt-1 pb-2 text-[10px] text-neutral-500">
